                ...
                <div class="panel panel-default" v-for='notebook in notebooks'>
                    ...
                    <form @submit.prevent="updateIt(notebook.id)">
                        ...
                        <div class="panel-body">
                            ...
                            <input v-show="showIt(notebook.id)" type="text" class="form-control" v-model="notebookEditData.body"> -by {{notebook.user.name}}
                        </div>
...
export default {
  ...
  methods: {
    ...
    updateIt(notebookId) {
      axios
        .put("/notebook/" + notebookId, this.notebookEditData)
        .then(response => {
