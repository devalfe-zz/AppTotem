  ...
  <card :title="$t('your_info')">
    <form @submit.prevent="create" @keydown="form.onKeydown($event)">
      <div class="form-group row">
        ...
        <div class="col-md-8">
          <input
            v-model="form.atractivo_id"
            type="text"
            name="atractivo_id"
            class="form-control"
            :class="{ 'is-invalid': form.errors.has('atractivo_id')}"
            disabled="disabled"
          />
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-5">
          <input
            ...
            :class="{ 'is-invalid': form.errors.has('foto_url') }"
          />
      ...
      swal({
        ...
        function() {
          const { response } = axios
            .delete("/api/v1/galeria/" + foto.id, foto)
            .then(
              function(response) {
                swal("Deleted!", "Your post has been deleted.", "success");
                self.$store.dispatch("category/updateCategory", {
