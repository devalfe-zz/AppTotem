...
<div class="row movie-card">
	...
	<img src="{{ env('APP_URL')}}{{$atractivos->foto_url}}" alt="{{ $atractivos->titulo }}" class="cover mw-100 mh-100" />
	<div class="col-xl-8 logo_detalle">
		...
		<img src="{{ env('APP_URL')}}{{$atractivos->foto_url}}" alt="{{ $atractivos->titulo }}" class="w-100 h-100" /> @endif
	</div>
	{{--
