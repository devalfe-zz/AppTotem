<div class="col-md-9">
    <div class="menu">
        <ul class="d-flex justify-content-around mt-3">
            <li><a href="{{ url('/inicio') }}"><i class="fa fa-home" aria-hidden="true"></i> Sobre Moquegua </a></li>
            <li><a href="{{ url('/dondeir') }}"><i class="fa fa-map" aria-hidden="true"></i> ¿Dónde ir? </a></li>
