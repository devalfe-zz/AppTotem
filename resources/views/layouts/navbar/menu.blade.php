<div class="col-md-9">
    <div class="menu">
        <ul class="d-flex justify-content-around mt-3">
            ...
            <li><a href="{{ route('servicios') }}"><i class="fa fa-plane" aria-hidden="true"></i>Servicios turísticos</a></li>
            <li><a  href="{{ route('multimedia') }}"><i class="fa fa-hotel" aria-hidden="true"></i> Multimedia </a></li>
