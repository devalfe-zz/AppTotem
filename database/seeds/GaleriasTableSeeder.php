...
class GaleriasTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        galeria::create([
            'Titulo' => 'PLAZA DE ARMAS',
            'foto_url' => 'images/atractivos/plaza2.jpg',
            'atractivo_id' => 2,
            'activo' => 1
        ]);
        ...
        galeria::create([
            'Titulo' => 'PLAZA DE ARMAS',
            'foto_url' => 'images/atractivos/plaza3.jpg',
            'atractivo_id' => 2,
            'activo' => 1
        ]);
        //3
        ...
        galeria::create([
            'Titulo' => 'CASA DE LOS FERNÁNDEZ CORNEJO Y FERNÁNDEZ DE CÓRDOBA',
            'foto_url' => 'images/atractivos/casa_diez_ventanas2.jpg',
            'atractivo_id' => 5,
            'activo' => 1
        ]);
        //6
        galeria::create([
            ...
            'foto_url' => 'images/atractivos/muro_matriz.jpg',
            'atractivo_id' => 6,
            'activo' => 1
        ]);
        ...
        galeria::create([
            'Titulo' => 'COMPLEJO SAN FRANCISCO Y LAS CATACUMBAS',
            'foto_url' => 'images/atractivos/complejo_san_francisco_catacumbas1.jpg',
            'atractivo_id' => 8,
            'activo' => 1
        ]);
        //9
        galeria::create([
            ...
            'foto_url' => 'images/atractivos/iglesia1.jpg',
            'atractivo_id' => 9,
            'activo' => 1
        ]);
        ...
        galeria::create([
            'Titulo' => 'COMPLEJO SANTO DOMINGO',
            'foto_url' => 'images/atractivos/iglesia2.jpg',
            'atractivo_id' => 9,
            'activo' => 1
        ]);
        ...
        galeria::create([
            'Titulo' => 'CASA DE LOS CABELLO',
            'foto_url' => 'images/atractivos/solar_de_cabellos1.jpg',
            'atractivo_id' => 10,
            'activo' => 1
        ]);
        ...
        galeria::create([
            'Titulo' => 'CASA DE LOS BARRIOS O CASA DE LA CULTURA',
            'foto_url' => 'images/atractivos/casa_cultura1.jpg',
            'atractivo_id' => 11,
            'activo' => 1
        ]);
        ...
        galeria::create([
            'Titulo' => 'CASA DE LOS BARRIOS O CASA DE LA CULTURA',
            'foto_url' => 'images/atractivos/casa_cultura2.jpg',
            'atractivo_id' => 11,
            'activo' => 1
        ]);
        ...
        galeria::create([
            'Titulo' => 'CASA DE LOS FERNÁNDEZ MALDONADO',
            'foto_url' => 'images/atractivos/casa_serpiente2.jpg',
            'atractivo_id' => 12,
            'activo' => 1
        ]);
        ...
        galeria::create([
            'Titulo' => 'CASA DE LOS DIEZ CANSECO Y FERNÁNDEZ DÁVILA',
            'foto_url' => 'images/atractivos/casa_diezcanseco2.jpg',
            'atractivo_id' => 13,
            'activo' => 1
        ]);
        ...
        galeria::create([
            'Titulo' => 'COMPLEJO BETLEMÍTICO Y EL BARRIO ',
            'foto_url' => 'images/atractivos/iglesia_belen2.jpg',
            'atractivo_id' => 15,
            'activo' => 1
        ]);
        ...
        galeria::create([
            'Titulo' => 'GEOGLIFOS DE CHEN CHEN',
            'foto_url' => 'images/atractivos/geoglifos2.jpg',
            'atractivo_id' => 20,
            'activo' => 1
        ]);
        ...
        galeria::create([
            'Titulo' => 'GEOGLIFOS DE CHEN CHEN',
            'foto_url' => 'images/atractivos/geoglifos3.jpg',
            'atractivo_id' => 20,
            'activo' => 1
        ]);
        //22
