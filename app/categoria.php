...
class Categoria extends Model
{
    ...
    {
        $icons = ['archway','award','hotel','images','map-marked-alt','store','server','portrait','passport','moon','map','medal','bookmark','building','bus','book','camera','home','image','tags'];
    ...
    {
        $colores = ['#e74c3c','#2ecc71','#e67e22','#1abc9c','#9b59b6','#1abcfc','#bb59b6','#2ebb71','#e67e11','#e67e55','#e67e66','#e45e22','#a74b3c','#e74f3f','#2eaa71','#1ab2f2','#aabcfc','#9c59c6','#2ecc71','#2ab1fa'];
